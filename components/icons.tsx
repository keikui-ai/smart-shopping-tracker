...
export const XCircleIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="12" cy="12" r="10" fill="inherit" stroke="none"/><path d="m15 9-6 6" stroke="white" strokeWidth="2"/><path d="m9 9 6 6" stroke="white" strokeWidth="2"/></svg>
);
...
export const EmptyListIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M6 19a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2Z"/><path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/></svg>
);

export const EmptyHistoryIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M21.44 11.05-9.19 2.35a1 1 0 0 0-1.05 0l-11 9.19a1 1 0 0 0 1.05 1.76l1.2-.99v6.59a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-6.59l1.2.99a1 1 0 0 0 1.05-1.76Z"/><path d="M15 11h-2v4h2Z"/><path d="M12 11H9.5a.5.5 0 0 0-.5.5v3a.5.5 0 0 0 .5.5H12Z"/></svg>
);

export const PriceTagIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2H2v10l9.29 9.29a1 1 0 0 0 1.41 0l8.59-8.59a1 1 0 0 0 0-1.41L12 2Z"/><path d="M7 7h.01"/></svg>
);
...
export const ReceiptTextScanIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-2 2Zm0 0L8 2"/>
        <path d="M16 8h-6"/>
        <path d="M16 12h-6"/>
        <path d="M10 16h.01"/>
    </svg>
